    ...
    public partial class initialdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_POS_Units", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_POS_SalesMasters_POS_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    POSUnitId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_POS_Products_POS_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalSchema: "dbo",
                        principalTable: "POS_Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_POS_ProductBatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_POS_ProductBatches_POS_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    POSProductBatchId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_POS_PurchaseDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_POS_PurchaseDetails_POS_ProductBatches_POSProductBatchId",
                        column: x => x.POSProductBatchId,
                        principalSchema: "dbo",
                        principalTable: "POS_ProductBatches",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    POSProductBatchId = table.Column<int>(type: "int", nullable: true),
                    POSProductId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_POS_SalesDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_POS_SalesDetails_POS_ProductBatches_POSProductBatchId",
                        column: x => x.POSProductBatchId,
                        principalSchema: "dbo",
                        principalTable: "POS_ProductBatches",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_POS_SalesDetails_POS_Products_POSProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_POS_ProductBatches_ProductId",
                schema: "dbo",
                table: "POS_ProductBatches",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_POS_SalesDetails_POSProductId",
                schema: "dbo",
                table: "POS_SalesDetails",
                column: "POSProductId");
